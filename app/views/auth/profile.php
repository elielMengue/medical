...
// Supprimer les messages de connexion sur la page de profil
        ...
        <div>
            ...
            <p>
                <span class="role-badge">
                    ...
                    $role = isset($user['role']) ? $user['role'] : $_SESSION['user_role'];
...
<div class="row">
    ...
    <div class="col-md-6">
        <div class="profile-card">
            ...
            <div class="info-value">
                ...
                <?php 
                $nom = isset($user['nom']) ? $user['nom'] : $_SESSION['user_nom'];
                $prenom = isset($user['prenom']) ? $user['prenom'] : $_SESSION['user_prenom'];
            ...
            <div class="info-value">
                ...
                <?php echo isset($user['email']) ? htmlspecialchars($user['email']) : htmlspecialchars($_SESSION['user_email']); ?>
            </div>
            ...
            <div class="info-value">
                <i class="bi bi-person-badge"></i>
                <?php 
                $matricule = isset($user['matricule']) ? $user['matricule'] : (isset($_SESSION['user_matricule']) ? $_SESSION['user_matricule'] : '');
            ...
            <div class="info-value">
                ...
                <?php 
                $telephone = isset($user['telephone']) ? $user['telephone'] : (isset($_SESSION['user_telephone']) ? $_SESSION['user_telephone'] : '');
            ...
            <div class="info-value">
                ...
                <?php 
                $service = isset($user['service']) ? $user['service'] : (isset($_SESSION['user_service']) ? $_SESSION['user_service'] : '');
            ...
            <div class="info-value">
                ...
                <?php 
                $centre = isset($user['centre']) ? $user['centre'] : (isset($_SESSION['user_centre']) ? $_SESSION['user_centre'] : '');
    ...
    <div class="col-md-6">
        <div class="profile-card">
            ...
            <a href="index.php?controller=auth&action=logout" class="btn btn-outline-danger w-100 hover-lift">
...
<!-- Styles CSS (gardés de ton fichier original) -->
<style>
.page-header {
