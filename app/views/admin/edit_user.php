...
<body>
    ...
    <div class="container">
        <div class="form-container hover-lift">
            ...
            <form method="POST" action="index.php?controller=admin&action=updateUser&id=<?php echo $userId; ?>">
                <div class="row mb-3">
                    <div class="col-md-6">
                        <label for="nom" class="form-label">Nom</label>
                        <input type="text" class="form-control form-control-lg nom-majuscule hover-lift" id="nom" name="nom" required 
                               placeholder="Entrez le nom"
                               value="<?php echo isset($user['nom']) ? htmlspecialchars(strtoupper($user['nom'])) : ''; ?>"
                    ...
                    <div class="col-md-6">
                        ...
                        <input type="text" class="form-control form-control-lg hover-lift" id="prenom" name="prenom" required 
                               ...
                               value="<?php echo isset($user['prenom']) ? htmlspecialchars(ucfirst(strtolower($user['prenom']))) : ''; ?>"
                ...
                <div class="row mb-3">
                    <div class="col-md-6">
                        ...
                        <input type="text" class="form-control form-control-lg hover-lift" id="matricule" name="matricule" required 
                               ...
                               value="<?php echo isset($user['matricule']) ? htmlspecialchars($user['matricule']) : ''; ?>">
                    </div>
                    <div class="col-md-6">
                        ...
                        <select class="form-select form-select-lg hover-lift" id="role" name="role" required>
                            ...
                            <option value="medecin" <?php echo (isset($user['role']) && $user['role'] == 'medecin') ? 'selected' : ''; ?>>Médecin</option>
                            <option value="major" <?php echo (isset($user['role']) && $user['role'] == 'major') ? 'selected' : ''; ?>>Major</option>
                            <option value="infirmier" <?php echo (isset($user['role']) && $user['role'] == 'infirmier') ? 'selected' : ''; ?>>Infirmier</option>
                        </select>
                    </div>
                </div>

                <!-- NOUVEAUX CHAMPS : Service et Centre (MODIFIÉS COMME DANS LE FORMULAIRE DE CRÉATION) -->
                <div class="row mb-3">
                    <div class="col-md-6">
                        <label for="service" class="form-label">Service</label>
                        <select class="form-select form-select-lg hover-lift" id="service" name="service">
                            <option value="">Sélectionner un service</option>
                            <option value="urgence medicale" <?php echo (isset($user['service']) && $user['service'] == 'urgence medicale') ? 'selected' : ''; ?>>Urgence médicale</option>
                            <option value="urgence chirurgicale" <?php echo (isset($user['service']) && $user['service'] == 'urgence chirurgicale') ? 'selected' : ''; ?>>Urgence chirurgicale</option>
                        </select>
                    ...
                    <div class="col-md-6">
                        ...
                        <select class="form-select form-select-lg hover-lift" id="centre" name="centre">
                            ...
                            <option value="amitié" <?php echo (isset($user['centre']) && $user['centre'] == 'amitié') ? 'selected' : ''; ?>>Amitié</option>
                            <option value="communautaire" <?php echo (isset($user['centre']) && $user['centre'] == 'communautaire') ? 'selected' : ''; ?>>Communautaire</option>
                        </select>
                        <div class="form-text">Optionnel</div>
                    </div>
                </div>
                ...
                <div class="row mb-3">
                    <div class="col-md-6">
                        ...
                        <input type="password" class="form-control form-control-lg hover-lift" id="password" name="password" 
                               placeholder="••••••••">
                    </div>
                    <div class="col-md-6">
                        <label for="confirm_password" class="form-label">Confirmer</label>
                        <input type="password" class="form-control form-control-lg hover-lift" id="confirm_password" name="confirm_password" 
                               placeholder="••••••••">
                    </div>
                </div>
